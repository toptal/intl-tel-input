...
(function(factory) {
   ...
   ********************/
        ...
        setPlaceholderNumberType: function(numberType) {
            if (window.intlTelInputUtils) {
                // placeholderNumberType is stored as the key name e.g. "MOBILE", so first we must work backwards and get the key from the value
                for (var prop in intlTelInputUtils.numberType) {
                    if (intlTelInputUtils.numberType.hasOwnProperty(prop) && intlTelInputUtils.numberType[prop] === numberType) {
                        this.options.placeholderNumberType = prop;
                        this._updatePlaceholder();
                        break;
                    }
                }
